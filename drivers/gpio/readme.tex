...
\begin{itemize}
  ...
  \item \textbf{Value Mapping \& Output:} Pass the captured 4-bit value to \texttt{SevenSeg(digit)} (\texttt{common/sevenseg.hpp}). The driver converts the digit into the correct segment pattern for the active-low common-anode display and writes it directly to \texttt{PORTB}.
